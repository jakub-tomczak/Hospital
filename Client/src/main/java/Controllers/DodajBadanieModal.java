...
public class DodajBadanieModal implements IDisplayedScreen{
    public ComboBox day;
    ...
    public  void addExamination()
    {
        ...
        if(lekarz!=null)
        {
            ...
            Sz_badania badanie = new Sz_badania(nazwa.getText(),formattedDate(),lekarz.getOddzialy_id(),pacjent.getId());
